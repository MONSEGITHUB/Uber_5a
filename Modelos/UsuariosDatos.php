<?php
require_once __DIR__ . '/../BasedeDatos/DB.php';
...
class PersonaModel {
    ...
    public function RecibirDatosPersonas() {
    ...
    public function agregarPersona($nombre, $direccion, $estado_civil, $sexo, $telefono) {
        try {
            // Convertir todo a mayúsculas antes de guardar
    ...
    public function actualizarPersona($id_persona, $nombre, $direccion, $estado_civil, $sexo, $telefono) {
        try {
            // Convertir todo a mayúsculas antes de actualizar
            $nombre = strtoupper($nombre);
            $direccion = strtoupper($direccion);
            $estado_civil = strtoupper($estado_civil);
            $sexo = strtoupper($sexo);
